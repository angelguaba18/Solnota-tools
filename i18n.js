...
(function () {
  ...
  var DICT = {
    // ---------- Portada (home) ----------
    "Hecho para artistas latinos · 0% comisión": { en: "Made for Latin artists · 0% commission", pt: "Feito para artistas latinos · 0% comissão", fr: "Conçu pour les artistes latinos · 0% commission" },
    "Mira cuánto dinero": { en: "See how much money", pt: "Veja quanto dinheiro", fr: "Vois combien d'argent" },
    "te debe tu música.": { en: "your music owes you.", pt: "a tua música te deve.", fr: "ta musique te doit." },
    "Tu música genera dinero hace años. Te mostramos cuánto no te está llegando — y te ayudamos a cobrarlo.": { en: "Your music has been making money for years. We show you how much isn't reaching you — and we help you collect it.", pt: "A tua música gera dinheiro há anos. Mostramos quanto não está chegando até ti — e te ajudamos a receber.", fr: "Ta musique génère de l'argent depuis des années. On te montre combien ne te parvient pas — et on t'aide à le percevoir." },
    "Gratis · 60 segundos · No tocamos tu dinero — va directo a tu banco. ·": { en: "Free · 60 seconds · We don't touch your money — it goes straight to your bank. ·", pt: "Grátis · 60 segundos · Não tocamos no teu dinheiro — vai direto pro teu banco. ·", fr: "Gratuit · 60 secondes · On ne touche pas à ton argent — il va directement à ta banque. ·" },
    "Cómo empieza →": { en: "How it starts →", pt: "Como começa →", fr: "Comment ça commence →" },
    "comisión": { en: "commission", pt: "comissão", fr: "commission" },
    "🔒 Nunca tocamos tu dinero": { en: "🔒 We never touch your money", pt: "🔒 Nunca tocamos no teu dinheiro", fr: "🔒 On ne touche jamais à ton argent" },
    "🎵 Tu música es": { en: "🎵 Your music is", pt: "🎵 A tua música é", fr: "🎵 Ta musique est" },
    "escáner": { en: "scanner", pt: "scanner", fr: "scanner" },
    "Encontramos sin reclamar": { en: "We found unclaimed", pt: "Encontramos sem reclamar", fr: "On a trouvé non réclamé" },
    "Con dinero suelto": { en: "With loose money", pt: "Com dinheiro solto", fr: "Avec de l'argent dispersé" },
    "Este dinero es tuyo →": { en: "This money is yours →", pt: "Este dinheiro é teu →", fr: "Cet argent est à toi →" },
    "en regalías sin cobrar en el mundo (estimado) · solo el MLC de EE.UU. ya tiene $424M+ esperando dueño": { en: "in uncollected royalties worldwide (estimated) · the US MLC alone has $424M+ waiting for an owner", pt: "em royalties não cobrados no mundo (estimado) · só o MLC dos EUA já tem $424M+ esperando dono", fr: "en redevances non perçues dans le monde (estimé) · rien que le MLC américain a déjà 424M$+ en attente de propriétaire" },
    "comisión sobre tus regalías — siempre": { en: "commission on your royalties — always", pt: "comissão sobre os teus royalties — sempre", fr: "commission sur tes redevances — toujours" },
    "idiomas · ES · EN · PT · FR · Latino-first": { en: "languages · ES · EN · PT · FR · Latino-first", pt: "idiomas · ES · EN · PT · FR · Latino-first", fr: "langues · ES · EN · PT · FR · Latino-first" },
    "El dinero de tu música": { en: "Your music's money", pt: "O dinheiro da tua música", fr: "L'argent de ta musique" },
    "Tu música genera 3 tipos de dinero. Casi nadie cobra los 2 importantes.": { en: "Your music makes 3 kinds of money. Almost no one collects the 2 important ones.", pt: "A tua música gera 3 tipos de dinheiro. Quase ninguém cobra os 2 importantes.", fr: "Ta musique génère 3 types d'argent. Presque personne ne perçoit les 2 importants." },
    "El máster ya lo cobras. Pero el": { en: "You already collect the master. But the", pt: "O máster tu já cobras. Mas o", fr: "Le master, tu le perçois déjà. Mais le" },
    "(mecánicas + performance) y el": { en: "(mechanicals + performance) and the", pt: "(mecânicas + performance) e o", fr: "(mécaniques + performance) et le" },
    "Ver dónde está tu dinero →": { en: "See where your money is →", pt: "Ver onde está o teu dinheiro →", fr: "Voir où est ton argent →" },
    "Mapa de tu dinero": { en: "Map of your money", pt: "Mapa do teu dinheiro", fr: "Carte de ton argent" },
    "Máster (ya lo cobras)": { en: "Master (you already collect it)", pt: "Máster (já cobras)", fr: "Master (tu le perçois déjà)" },
    "Tu dinero llega directo a tu banco. Nosotros nunca lo tocamos.": { en: "Your money goes straight to your bank. We never touch it.", pt: "O teu dinheiro chega direto ao teu banco. Nós nunca tocamos nele.", fr: "Ton argent arrive directement à ta banque. On n'y touche jamais." },
    "Registramos y cobramos todo por ti (MLC, BMI/PRO, SoundExchange) con tu acuerdo firmado. El dinero va": { en: "We register and collect everything for you (MLC, BMI/PRO, SoundExchange) with your signed agreement. The money goes", pt: "Registramos e cobramos tudo por ti (MLC, BMI/PRO, SoundExchange) com o teu acordo assinado. O dinheiro vai", fr: "On enregistre et perçoit tout pour toi (MLC, BMI/PRO, SoundExchange) avec ton accord signé. L'argent va" },
    "— 0% de comisión, cancelas cuando quieras.": { en: "— 0% commission, cancel whenever you want.", pt: "— 0% de comissão, cancelas quando quiseres.", fr: "— 0% de commission, annule quand tu veux." },
    "Tu panel de regalías": { en: "Your royalty dashboard", pt: "O teu painel de royalties", fr: "Ton tableau de redevances" },
    "mecánicas · activo": { en: "mechanicals · active", pt: "mecânicas · ativo", fr: "mécaniques · actif" },
    "→ A tu banco, directo": { en: "→ To your bank, direct", pt: "→ Pro teu banco, direto", fr: "→ Vers ta banque, direct" },
    "Descubre qué controla tu sello — y qué dinero es tuyo, sin romper tu deal.": { en: "Find out what your label controls — and what money is yours, without breaking your deal.", pt: "Descobre o que o teu selo controla — e que dinheiro é teu, sem quebrar o teu deal.", fr: "Découvre ce que ton label contrôle — et quel argent est à toi, sans casser ton deal." },
    "Responde 5 preguntas y SOLNOTA te explica tu contrato con un semáforo claro: qué está bloqueado y qué puedes cobrar hoy mismo.": { en: "Answer 5 questions and SOLNOTA explains your contract with a clear traffic light: what's blocked and what you can collect today.", pt: "Responde 5 perguntas e a SOLNOTA explica o teu contrato com um semáforo claro: o que está bloqueado e o que podes cobrar hoje.", fr: "Réponds à 5 questions et SOLNOTA t'explique ton contrat avec un feu clair : ce qui est bloqué et ce que tu peux percevoir aujourd'hui." },
    "Semáforo de derechos": { en: "Rights traffic light", pt: "Semáforo de direitos", fr: "Feu des droits" },
    "análisis": { en: "analysis", pt: "análise", fr: "analyse" },
    "Mecánicas (MLC)": { en: "Mechanicals (MLC)", pt: "Mecânicas (MLC)", fr: "Mécaniques (MLC)" },
    "Distribución del máster": { en: "Master distribution", pt: "Distribuição do máster", fr: "Distribution du master" },
    "Sello": { en: "Label", pt: "Selo", fr: "Label" },
    "Escanea tu música": { en: "Scan your music", pt: "Escaneia a tua música", fr: "Scanne ta musique" },
    "Mete tu nombre y ve tu catálogo + el dinero sin reclamar. Gratis.": { en: "Enter your name and see your catalog + the unclaimed money. Free.", pt: "Coloca o teu nome e vê o teu catálogo + o dinheiro sem reclamar. Grátis.", fr: "Mets ton nom et vois ton catalogue + l'argent non réclamé. Gratuit." },
    "Sube tu catálogo y encuentra errores de %, black box y duplicados. Te dice cuánto pierdes.": { en: "Upload your catalog and find % errors, black box and duplicates. It tells you how much you're losing.", pt: "Envia o teu catálogo e encontra erros de %, black box e duplicados. Diz quanto perdes.", fr: "Téléverse ton catalogue et trouve les erreurs de %, le black box et les doublons. Il te dit combien tu perds." },
    "5 preguntas → semáforo de qué controla tu sello y qué es tuyo.": { en: "5 questions → traffic light of what your label controls and what's yours.", pt: "5 perguntas → semáforo do que o teu selo controla e o que é teu.", fr: "5 questions → feu de ce que ton label contrôle et ce qui est à toi." },
    "Verifica dónde hay regalías pendientes: SoundExchange, MLC, PRO.": { en: "Check where there are pending royalties: SoundExchange, MLC, PRO.", pt: "Verifica onde há royalties pendentes: SoundExchange, MLC, PRO.", fr: "Vérifie où il y a des redevances en attente : SoundExchange, MLC, PRO." },
    "Escáner multi-rol (cantante, productor, compositor) con export CSV.": { en: "Multi-role scanner (singer, producer, songwriter) with CSV export.", pt: "Scanner multi-papel (cantor, produtor, compositor) com export CSV.", fr: "Scanner multi-rôle (chanteur, producteur, compositeur) avec export CSV." },
    "Tarifa plana, 0% comisión. Cancela cuando quieras.": { en: "Flat fee, 0% commission. Cancel whenever you want.", pt: "Taxa fixa, 0% comissão. Cancela quando quiseres.", fr: "Tarif fixe, 0% commission. Annule quand tu veux." },
    "Cómo funciona": { en: "How it works", pt: "Como funciona", fr: "Comment ça marche" },
    "De tu música a tu banco, en 3 pasos": { en: "From your music to your bank, in 3 steps", pt: "Da tua música ao teu banco, em 3 passos", fr: "De ta musique à ta banque, en 3 étapes" },
    "Tú haces 1 cosa. Lo demás es automático.": { en: "You do 1 thing. The rest is automatic.", pt: "Tu fazes 1 coisa. O resto é automático.", fr: "Tu fais 1 chose. Le reste est automatique." },
    "Escribe tu nombre de artista. En 60 segundos ves cuánto dinero tienes sin cobrar. Gratis.": { en: "Enter your artist name. In 60 seconds you see how much money you have uncollected. Free.", pt: "Escreve o teu nome de artista. Em 60 segundos vês quanto dinheiro tens sem cobrar. Grátis.", fr: "Écris ton nom d'artiste. En 60 secondes tu vois combien d'argent tu n'as pas perçu. Gratuit." },
    "Dinos quién hizo cada canción y su %. Eso es lo único que tú haces.": { en: "Tell us who made each song and their %. That's the only thing you do.", pt: "Diz-nos quem fez cada música e o seu %. Isso é a única coisa que tu fazes.", fr: "Dis-nous qui a fait chaque chanson et son %. C'est la seule chose que tu fais." },
    "Registramos todo (MLC, PRO, SoundExchange). El dinero cae solo a tu banco. 0% comisión.": { en: "We register everything (MLC, PRO, SoundExchange). The money lands in your bank by itself. 0% commission.", pt: "Registramos tudo (MLC, PRO, SoundExchange). O dinheiro cai sozinho no teu banco. 0% comissão.", fr: "On enregistre tout (MLC, PRO, SoundExchange). L'argent arrive seul dans ta banque. 0% commission." },
    "No. El dinero va": { en: "No. The money goes", pt: "Não. O dinheiro vai", fr: "Non. L'argent va" },
    "directo a tu banco": { en: "straight to your bank", pt: "direto pro teu banco", fr: "directement à ta banque" },
    "¿Cuánto cobran?": { en: "How much do you charge?", pt: "Quanto cobram?", fr: "Combien prenez-vous ?" },
    "0% de comisión": { en: "0% commission", pt: "0% de comissão", fr: "0% de commission" },
    "sobre tus regalías. Tarifa plana y cancelas cuando quieras.": { en: "on your royalties. Flat fee and cancel whenever you want.", pt: "sobre os teus royalties. Taxa fixa e cancelas quando quiseres.", fr: "sur tes redevances. Tarif fixe et annule quand tu veux." },
    "¿Pierdo los derechos de mi música?": { en: "Do I lose the rights to my music?", pt: "Perco os direitos da minha música?", fr: "Est-ce que je perds les droits de ma musique ?" },
    "Jamás. Tu música es": { en: "Never. Your music is", pt: "Jamais. A tua música é", fr: "Jamais. Ta musique est" },
    ", siempre. Solo te ayudamos a cobrar lo que ya es tuyo.": { en: ", always. We just help you collect what's already yours.", pt: ", sempre. Só te ajudamos a cobrar o que já é teu.", fr: ", toujours. On t'aide juste à percevoir ce qui est déjà à toi." },
    "¿Funciona si ya tengo sello o distribuidora?": { en: "Does it work if I already have a label or distributor?", pt: "Funciona se eu já tenho selo ou distribuidora?", fr: "Ça marche si j'ai déjà un label ou un distributeur ?" },
    "Sí. Cobramos el": { en: "Yes. We collect the", pt: "Sim. Cobramos o", fr: "Oui. On perçoit le" },
    "(lo que tu sello casi nunca cobra) sin romper tu deal actual.": { en: "(what your label almost never collects) without breaking your current deal.", pt: "(o que o teu selo quase nunca cobra) sem quebrar o teu deal atual.", fr: "(ce que ton label ne perçoit presque jamais) sans casser ton deal actuel." },
    "¿Necesito tarjeta para escanear?": { en: "Do I need a card to scan?", pt: "Preciso de cartão para escanear?", fr: "Ai-je besoin d'une carte pour scanner ?" },
    "gratis": { en: "free", pt: "grátis", fr: "gratuit" },
    "Tu música ya hizo el dinero.": { en: "Your music already made the money.", pt: "A tua música já fez o dinheiro.", fr: "Ta musique a déjà gagné l'argent." },
    "Escanea gratis en 60 segundos. Sin tarjeta, sin compromiso.": { en: "Scan free in 60 seconds. No card, no commitment.", pt: "Escaneia grátis em 60 segundos. Sem cartão, sem compromisso.", fr: "Scanne gratuitement en 60 secondes. Sans carte, sans engagement." },
    "Obras detectadas": { en: "Works detected", pt: "Obras detectadas", fr: "Œuvres détectées" },
    "Black box recuperable": { en: "Recoverable black box", pt: "Black box recuperável", fr: "Black box récupérable" },
    "directo a tu cuenta": { en: "straight to your account", pt: "direto pra tua conta", fr: "directement sur ton compte" },
    "Todo lo que necesitas para cobrar": { en: "Everything you need to get paid", pt: "Tudo o que precisas para cobrar", fr: "Tout ce qu'il te faut pour être payé" },
    "Herramientas profesionales, en tu idioma.": { en: "Professional tools, in your language.", pt: "Ferramentas profissionais, no teu idioma.", fr: "Des outils pro, dans ta langue." },
    "Reparte splits y genera el archivo CWR byte-perfect para PROs y MLC.": { en: "Split shares and generate the byte-perfect CWR file for PROs and MLC.", pt: "Divide os splits e gera o arquivo CWR byte-perfect para PROs e MLC.", fr: "Répartis les splits et génère le fichier CWR byte-perfect pour les PRO et le MLC." },
    "Sube tu split": { en: "Upload your split", pt: "Envia o teu split", fr: "Téléverse ton split" },
    "Cobras": { en: "You get paid", pt: "Cobras", fr: "Tu es payé" },
    ". Somos el GPS, no el chofer — nunca tocamos tu plata ni entramos a tus cuentas.": { en: ". We're the GPS, not the driver — we never touch your money or enter your accounts.", pt: ". Somos o GPS, não o motorista — nunca tocamos no teu dinheiro nem entramos nas tuas contas.", fr: ". On est le GPS, pas le chauffeur — on ne touche jamais à ton argent ni n'entre dans tes comptes." },
    "No. El escaneo es": { en: "No. The scan is", pt: "Não. O escaneamento é", fr: "Non. Le scan est" },
    "y sin compromiso.": { en: "and no commitment.", pt: "e sem compromisso.", fr: "et sans engagement." },
    // ---------- Splitsheet / Visor (huecos) ----------
    "📤 ¿A dónde envío este CWR?": { en: "📤 Where do I send this CWR?", pt: "📤 Para onde envio este CWR?", fr: "📤 Où envoyer ce CWR ?" },
    "Mecánicas (USA):": { en: "Mechanicals (USA):", pt: "Mecânicas (EUA):", fr: "Mécaniques (É.-U.) :" },
    "Reclamar regalías": { en: "Claim royalties", pt: "Reclamar royalties", fr: "Réclamer les redevances" },
    // ---------- El Doctor · Blindar / pestañas (nuevo) ----------
    "🩺 Auditar lo que ya tengo": { en: "🩺 Audit what I have", pt: "🩺 Auditar o que já tenho", fr: "🩺 Auditer ce que j'ai" },
    "🛡️ Blindar antes de soltar": { en: "🛡️ Shield before releasing", pt: "🛡️ Blindar antes de lançar", fr: "🛡️ Blinder avant de sortir" },
    "👁️ Vigilar mis lanzamientos · pronto": { en: "👁️ Watch my releases · soon", pt: "👁️ Vigiar meus lançamentos · em breve", fr: "👁️ Surveiller mes sorties · bientôt" },
    "Ve a \"Repertory\" / tus títulos.": { en: "Go to \"Repertory\" / your titles.", pt: "Vai a \"Repertory\" / os teus títulos.", fr: "Va dans \"Repertory\" / tes titres." },
    "Menú \"Works\" → tus obras.": { en: "\"Works\" menu → your works.", pt: "Menu \"Works\" → as tuas obras.", fr: "Menu \"Works\" → tes œuvres." },
    "Antes de soltar tu canción, pásala por este chequeo. Si todo está ✅, tu dinero te va a llegar — no se queda botado. Es el mismo Doctor, pero": { en: "Before releasing your song, run it through this check. If everything is ✅, your money will reach you — it won't be left behind. It's the same Doctor, but", pt: "Antes de lançar a tua música, passa por este check. Se tudo estiver ✅, o teu dinheiro vai chegar — não fica perdido. É o mesmo Doctor, mas", fr: "Avant de sortir ta chanson, passe-la par ce contrôle. Si tout est ✅, ton argent te parviendra — il ne sera pas perdu. C'est le même Doctor, mais" },
    "antes": { en: "before", pt: "antes", fr: "avant" },
    "para tu próximo lanzamiento": { en: "for your next release", pt: "para o teu próximo lançamento", fr: "pour ta prochaine sortie" },
    "ℹ️ Esto es una": { en: "ℹ️ This is a", pt: "ℹ️ Isto é uma", fr: "ℹ️ Ceci est un" },
    "guía": { en: "guide", pt: "guia", fr: "guide" },
    "según lo que tú marcas — no una prueba. La prueba real de cuánto pierdes es subir tu catálogo en": { en: "based on what you check — not proof. The real proof of how much you're losing is uploading your catalog in", pt: "conforme o que marcas — não uma prova. A prova real de quanto perdes é enviar o teu catálogo em", fr: "selon ce que tu coches — pas une preuve. La vraie preuve de combien tu perds, c'est de téléverser ton catalogue dans" },
    "🩺 Auditar": { en: "🩺 Audit", pt: "🩺 Auditar", fr: "🩺 Auditer" },
    "Split sheet firmado por TODOS los que escribieron": { en: "Split sheet signed by EVERYONE who wrote it", pt: "Split sheet assinado por TODOS que escreveram", fr: "Split sheet signé par TOUS ceux qui ont écrit" },
    "⚠️ Split sheet firmado por TODOS los que escribieron": { en: "⚠️ Split sheet signed by EVERYONE who wrote it", pt: "⚠️ Split sheet assinado por TODOS que escreveram", fr: "⚠️ Split sheet signé par TOUS ceux qui ont écrit" },
    "El papel donde cada quien acepta su %. Sin firma, después cualquiera puede reclamar de más.": { en: "The paper where everyone agrees to their %. Without a signature, anyone can later overclaim.", pt: "O papel onde cada um aceita o seu %. Sem assinatura, depois qualquer um pode reclamar a mais.", fr: "Le papier où chacun accepte son %. Sans signature, n'importe qui peut ensuite surréclamer." },
    "🔧 Hazlo y fírmenlo ANTES de subir la canción. Puedes usar el Split sheet de SOLNOTA.": { en: "🔧 Do it and sign it BEFORE uploading the song. You can use SOLNOTA's Split sheet.", pt: "🔧 Faz e assinem ANTES de subir a música. Podes usar o Split sheet da SOLNOTA.", fr: "🔧 Fais-le et signez AVANT de mettre la chanson en ligne. Tu peux utiliser le Split sheet de SOLNOTA." },
    "Los % suman exactamente 100%": { en: "The % add up to exactly 100%", pt: "Os % somam exatamente 100%", fr: "Les % font exactement 100%" },
    "Ni más ni menos.": { en: "No more, no less.", pt: "Nem mais, nem menos.", fr: "Ni plus, ni moins." },
    "🔧 Si suman MÁS de 100 = overclaim (se traba el pago). Si suman MENOS = black box (falta dueño). Ajusta hasta 100 clavado.": { en: "🔧 If they add up to MORE than 100 = overclaim (payment gets stuck). If LESS = black box (missing owner). Adjust to exactly 100.", pt: "🔧 Se somam MAIS de 100 = overclaim (trava o pagamento). Se MENOS = black box (falta dono). Ajusta até 100 certinho.", fr: "🔧 Si ça fait PLUS de 100 = surréclamation (le paiement bloque). Si MOINS = black box (propriétaire manquant). Ajuste à 100 pile." },
    "Tu editor (publisher) está puesto sobre tu parte": { en: "Your publisher is set on your share", pt: "O teu editor (publisher) está na tua parte", fr: "Ton éditeur (publisher) est sur ta part" },
    "⚠️ Tu editor (publisher) está puesto sobre tu parte": { en: "⚠️ Your publisher is set on your share", pt: "⚠️ O teu editor (publisher) está na tua parte", fr: "⚠️ Ton éditeur (publisher) est sur ta part" },
    "Tu % de escritor necesita un editor que lo cobre.": { en: "Your writer % needs a publisher to collect it.", pt: "O teu % de escritor precisa de um editor que o cobre.", fr: "Ton % d'auteur a besoin d'un éditeur pour le percevoir." },
    "🔧 Sin editor, tu publishing cae en black box y nadie lo cobra. Pon Sol Music Group (o el tuyo) sobre tu %.": { en: "🔧 Without a publisher, your publishing falls into black box and no one collects it. Put Sol Music Group (or yours) on your %.", pt: "🔧 Sem editor, o teu publishing cai em black box e ninguém cobra. Põe Sol Music Group (ou o teu) na tua %.", fr: "🔧 Sans éditeur, ton publishing tombe en black box et personne ne le perçoit. Mets Sol Music Group (ou le tien) sur ta %." },
    "Tu nombre + IPI son idénticos a tus otras obras": { en: "Your name + IPI are identical to your other works", pt: "O teu nome + IPI são idênticos às tuas outras obras", fr: "Ton nom + IPI sont identiques à tes autres œuvres" },
    "⚠️ Tu nombre + IPI son idénticos a tus otras obras": { en: "⚠️ Your name + IPI are identical to your other works", pt: "⚠️ O teu nome + IPI são idênticos às tuas outras obras", fr: "⚠️ Ton nom + IPI sont identiques à tes autres œuvres" },
    "Mismo nombre legal y mismo número IPI, siempre igual.": { en: "Same legal name and same IPI number, always the same.", pt: "Mesmo nome legal e mesmo número IPI, sempre igual.", fr: "Même nom légal et même numéro IPI, toujours identiques." },
    "🔧 Si escribes tu nombre distinto o cambias el IPI, el dinero no hace match y se pierde. Usa SIEMPRE el mismo.": { en: "🔧 If you write your name differently or change the IPI, the money won't match and gets lost. ALWAYS use the same.", pt: "🔧 Se escreves o teu nome diferente ou mudas o IPI, o dinheiro não dá match e perde-se. Usa SEMPRE o mesmo.", fr: "🔧 Si tu écris ton nom différemment ou changes l'IPI, l'argent ne correspond pas et se perd. Utilise TOUJOURS le même." },
    "Registrada en tu PRO (BMI / ASCAP)": { en: "Registered with your PRO (BMI / ASCAP)", pt: "Registada na tua PRO (BMI / ASCAP)", fr: "Enregistrée auprès de ta PRO (BMI / ASCAP)" },
    "⚠️ Registrada en tu PRO (BMI / ASCAP)": { en: "⚠️ Registered with your PRO (BMI / ASCAP)", pt: "⚠️ Registada na tua PRO (BMI / ASCAP)", fr: "⚠️ Enregistrée auprès de ta PRO (BMI / ASCAP)" },
    "Tu PRO cobra la performance — que la canción suene.": { en: "Your PRO collects performance — the song being played.", pt: "A tua PRO cobra a performance — a música a tocar.", fr: "Ta PRO perçoit la performance — la chanson qui passe." },
    "🔧 Si no la registras en tu PRO, ese dinero no llega. Regístrala apenas salga.": { en: "🔧 If you don't register it with your PRO, that money won't arrive. Register it as soon as it's out.", pt: "🔧 Se não a registas na tua PRO, esse dinheiro não chega. Regista-a assim que sair.", fr: "🔧 Si tu ne l'enregistres pas auprès de ta PRO, cet argent n'arrive pas. Enregistre-la dès sa sortie." },
    "Va al MLC (mecánicas del streaming en EE.UU.)": { en: "Goes to the MLC (US streaming mechanicals)", pt: "Vai ao MLC (mecânicas do streaming nos EUA)", fr: "Va au MLC (mécaniques du streaming aux É.-U.)" },
    "⚠️ Va al MLC (mecánicas del streaming en EE.UU.)": { en: "⚠️ Goes to the MLC (US streaming mechanicals)", pt: "⚠️ Vai ao MLC (mecânicas do streaming nos EUA)", fr: "⚠️ Va au MLC (mécaniques du streaming aux É.-U.)" },
    "El MLC paga gran parte de lo que termina en black box.": { en: "The MLC pays much of what ends up in black box.", pt: "O MLC paga grande parte do que acaba em black box.", fr: "Le MLC paie une grande partie de ce qui finit en black box." },
    "🔧 Asegúrate de que tu editor registre la obra en el MLC. Ahí está el dinero que casi nadie cobra.": { en: "🔧 Make sure your publisher registers the work with the MLC. That's where the money almost no one collects is.", pt: "🔧 Garante que o teu editor regista a obra no MLC. Ali está o dinheiro que quase ninguém cobra.", fr: "🔧 Assure-toi que ton éditeur enregistre l'œuvre au MLC. C'est là qu'est l'argent que presque personne ne perçoit." },
    "Solo registras lo que TÚ controlas": { en: "You only register what YOU control", pt: "Só registas o que TU controlas", fr: "Tu n'enregistres que ce que TU contrôles" },
    "⚠️ Solo registras lo que TÚ controlas": { en: "⚠️ You only register what YOU control", pt: "⚠️ Só registas o que TU controlas", fr: "⚠️ Tu n'enregistres que ce que TU contrôles" },
    "No metas obras que un sello tiene capturadas (recoupment).": { en: "Don't add works a label has captured (recoupment).", pt: "Não metas obras que um selo tem capturadas (recoupment).", fr: "N'ajoute pas d'œuvres qu'un label a capturées (recoupment)." },
    "🔧 Reclamar lo que no controlas se traba o se revierte. Verifica antes de reclamar.": { en: "🔧 Claiming what you don't control gets stuck or reversed. Verify before claiming.", pt: "🔧 Reclamar o que não controlas trava ou reverte. Verifica antes de reclamar.", fr: "🔧 Réclamer ce que tu ne contrôles pas bloque ou s'annule. Vérifie avant de réclamer." },
    "Arregla estos antes de soltar — cada uno es dinero que se te puede ir al black box:": { en: "Fix these before releasing — each one is money that can slip into black box:", pt: "Arruma estes antes de lançar — cada um é dinheiro que pode ir pro black box:", fr: "Corrige ceux-ci avant de sortir — chacun est de l'argent qui peut filer en black box :" },
    "🛡️ Blindada — lista para soltar sin perder dinero": { en: "🛡️ Shielded — ready to release without losing money", pt: "🛡️ Blindada — pronta para lançar sem perder dinheiro", fr: "🛡️ Blindée — prête à sortir sans perdre d'argent" },
    "Cumpliste los 7 puntos. Tu canción nueva no debería caer en black box. Repite este chequeo en CADA lanzamiento.": { en: "You met all 7 points. Your new song shouldn't fall into black box. Repeat this check on EVERY release.", pt: "Cumpriste os 7 pontos. A tua música nova não devia cair em black box. Repete este check em CADA lançamento.", fr: "Tu as rempli les 7 points. Ta nouvelle chanson ne devrait pas tomber en black box. Refais ce contrôle à CHAQUE sortie." },
    "Blindaje": { en: "Shielding", pt: "Blindagem", fr: "Blindage" },
    "Por arreglar": { en: "To fix", pt: "Para arrumar", fr: "À corriger" },
    // ---------- El Doctor ----------
