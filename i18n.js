...
"Abrir →": { en: "Open →", pt: "Abrir →", fr: "Ouvrir →" },
    ...
    "No somos un sello. No somos abogados. Somos gente del movimiento urbano latino que se cansó de ver a los artistas perder lo que es suyo.": { en: "We're not a label. We're not lawyers. We're people from the Latin urban scene who got tired of watching artists lose what's theirs.", pt: "Não somos uma gravadora. Não somos advogados. Somos gente do movimento urbano latino que se cansou de ver artistas perderem o que é seu.", fr: "Nous ne sommes pas un label. Nous ne sommes pas des avocats. Nous sommes des gens de la scène urbaine latino qui en ont assez de voir les artistes perdre ce qui leur revient." },
