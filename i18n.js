...
(function () {
  ...
  var DICT = {
    ...
    "Escribe un artista y escanea. (En vivo funciona en navegador real / Netlify.)": { en: "Type an artist and scan. (Live works in a real browser.)", pt: "Digite um artista e escaneie. (Ao vivo funciona em navegador real.)", fr: "Saisissez un artiste et scannez. (En direct, fonctionne dans un vrai navigateur.)" },
    ...
    "El escáner en vivo funciona en navegador real o Netlify (el visor de artifacts bloquea internet).": { en: "The live scanner works in a real browser (the artifact viewer blocks internet).", pt: "O scanner ao vivo funciona em navegador real (o visualizador de artifacts bloqueia a internet).", fr: "Le scanner en direct fonctionne dans un vrai navigateur (la visionneuse d'artifacts bloque internet)." },
